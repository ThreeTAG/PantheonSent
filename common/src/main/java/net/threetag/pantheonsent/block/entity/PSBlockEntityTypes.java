...
public class PSBlockEntityTypes {
    ...
    public static final RegistrySupplier<BlockEntityType<SuspiciousSandBlockEntity>> SUSPICIOUS_SAND = BLOCK_ENTITIES.register("brushable", () -> BlockEntityType.Builder.of(SuspiciousSandBlockEntity::new, PSBlocks.SUSPICIOUS_SAND.get()).build(null));
