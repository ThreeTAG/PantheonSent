...
public class PSBlocks {
    ...
    public static final RegistrySupplier<Block> ARCHEOLOGY_TABLE = BLOCKS.register("archeology_table", () -> new Block(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
