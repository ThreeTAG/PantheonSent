...
public class KhonshuModel<T extends LivingEntity> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(32, 20).addBox(-5.0F, -8.0F, -3.0F, 10.0F, 15.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 20).addBox(-5.0F, -8.0F, -3.0F, 10.0F, 15.0F, 6.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -4.0F, 1.0F));

        PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(76, 41).addBox(-4.0F, -2.0F, -3.0F, 5.0F, 19.0F, 6.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition staff = right_arm.addOrReplaceChild("staff", CubeListBuilder.create().texOffs(0, 68).addBox(-0.8333F, -1.0F, -3.6667F, 2.0F, 2.0F, 46.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(60, 62).addBox(-2.5F, 0.0F, -3.0F, 5.0F, 21.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(22, 41).addBox(-2.5F, 0.0F, -3.0F, 5.0F, 21.0F, 6.0F, new CubeDeformation(0.25F)), PartPose.offset(-2.5F, 3.0F, 1.0F));

        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(44, 41).addBox(-2.5F, 0.0F, -3.0F, 5.0F, 21.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 41).addBox(-2.5F, 0.0F, -3.0F, 5.0F, 21.0F, 6.0F, new CubeDeformation(0.25F)), PartPose.offset(2.5F, 3.0F, 1.0F));

        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -8.0F, -6.0F, 10.0F, 9.0F, 11.0F, new CubeDeformation(0.0F))
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        // DEBUG
        // limbSwing = Mth.sin(entity.tickCount / 10F) ;
        // limbSwingAmount = Mth.sin(entity.tickCount / 10F);
