...
import net.threetag.pantheonsent.client.model.ThrownBatonModel;
import net.threetag.pantheonsent.entity.CrescentDart;
import net.threetag.pantheonsent.entity.ThrownBaton;
import org.jetbrains.annotations.NotNull;

public class ThrownBatonRenderer extends EntityRenderer<ThrownBaton> {

    public static final ResourceLocation TEXTURE = PantheonSent.id("textures/entity/projectiles/baton.png");
    private final ThrownBatonModel model;

    public ThrownBatonRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new ThrownBatonModel(context.bakeLayer(ThrownBatonModel.MODEL_LAYER));
    }

    @Override
    public void render(ThrownBaton entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(ThrownBaton entity) {
        return TEXTURE;
    }
}
