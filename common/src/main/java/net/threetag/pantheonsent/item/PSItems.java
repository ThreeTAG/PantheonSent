...
//    public static final RegistrySupplier<Item> MYSTERIOUS_GRAVEL = ITEMS.register("mysterious_gravel", () -> new SortedBlockItem(PSBlocks.MYSTERIOUS_GRAVEL.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS), FILLER_AFTER_GRAVEL));
    public static final RegistrySupplier<Item> SUSPICIOUS_SAND = ITEMS.register("suspicious_sand", () -> new SortedBlockItem(PSBlocks.SUSPICIOUS_SAND.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS), FILLER_AFTER_SAND));
    ...
    public static final RegistrySupplier<Item> BRUSH = ITEMS.register("brush", () -> new BrushItem(new Item.Properties().durability(64).tab(CreativeModeTab.TAB_TOOLS)));
    ...
    public static final RegistrySupplier<Item> MUSIC_DISK_CHONS = ITEMS.register("music_disc_chons", () -> PalladiumRecordItem.create(1, PSSoundEvents.MUSIC_DISC_CHONS, (new Item.Properties()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE), 69));
